...
public class Hfh_CardType
{
	...
	public void AutoReserveCards(int[] cards)
	{
		...
		for (int num55 = 0; num55 < FlushStraight.Count; num55++)
		{
			int num56 = 0;
			for (int num57 = 0; num57 < FlushStraight[num55].Length; num57++)
			{
				if (FlushStraight[num55][num57] != -1)
				{
					num56++;
				}
			}
			if (num56 + list.Count >= 4)
			{
				if (num56 + list.Count == 5)
				{
					IsGetFive = true;
				}
		...
		for (int num58 = 0; num58 < Flush.Count; num58++)
		{
			int num59 = 0;
			for (int num60 = 0; num60 < Flush[num58].Length; num60++)
			{
				if (Flush[num58][num60] != -1)
				{
					num59++;
				}
			}
			if (num59 + list.Count >= 4)
			{
				if (num59 + list.Count == 5)
				{
					IsGetFive = true;
				}
				IsFlush = true;
		...
		for (int num61 = 0; num61 < Straight.Count; num61++)
		{
			int num62 = 0;
			for (int num63 = 0; num63 < Straight[num61].Length; num63++)
			{
				if (Straight[num61][num63] != -1)
				{
					num62++;
				}
			}
			if (num62 + list.Count >= 4)
			{
				if (num62 + list.Count == 5)
				{
					IsGetFive = true;
				}
				IsStraight = true;
