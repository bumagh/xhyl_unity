...
public class LL_LuckyLion_SoundManager : MonoBehaviour
{
	...
	protected static LL_LuckyLion_SoundManager gSingleton;
	...
	public static LL_LuckyLion_SoundManager GetSingleton()
	{
		return gSingleton;
	}
	...
	public void PlayGameHallMusic()
	{
		...
		{
			LL_ErrorManager.GetSingleton().AddError("game hall background source null");
		}
		else
		{
			LL_ErrorManager.GetSingleton().AddError("game hall background clip null");
		}
	}
	...
	public void playButtonSound(EUIBtnSoundType soundType = EUIBtnSoundType.BtnSound)
	{
		...
		{
			LL_ErrorManager.GetSingleton().AddError("button source null");
		}
		else
		{
			LL_ErrorManager.GetSingleton().AddError("button clip null");
		}
	}
	...
	public void SetMusicVolume(float fVolume)
	{
		...
		{
			LL_ErrorManager.GetSingleton().AddError("Error:音量设置错误" + fVolume);
			fVolume = 0.5f;
		}
