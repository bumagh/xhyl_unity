...
public class MSE_Rsymbol
{
	...
	public MSE_Rsymbol(Transform tran, int idx, MSE_RollSymbol RS, MSE_Symdata data, Action stopaction)
	{
		Rs = RS;
		Tran = tran;
		Data = data;
	...
	{
		frame = frameimg;
		seq_frame = frame.MSE_PlayAni("icon_guangxiao{0:0}", 1, 15f);
		seq_ani = img.MSE_PlayAni("spirit_big_{0:00}", 0, 15f);
		isbig = true;
	}
