...
public class LKB_NoticeController : LKB_MB_Singleton<LKB_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			LKB_MB_Singleton<LKB_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
