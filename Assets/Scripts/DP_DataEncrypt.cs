...
public class DP_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static DP_DataEncrypt _MyDataEncrypt;
	...
	public static DP_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			DP_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
}
