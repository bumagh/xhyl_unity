...
public class LRS_NoticeController : LRS_MB_Singleton<LRS_NoticeController>
{
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			LRS_MB_Singleton<LRS_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
