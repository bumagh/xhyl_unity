...
public class STMF_PrizePlate : MonoBehaviour
{
	...
	private Canvas cvPlate;

	private Canvas cvNum;
	...
	private void Awake()
	{
		...
		cvPlate = _plateObj.GetComponent<Canvas>();
		if (cvPlate != null)
		{
			cvPlate.sortingOrder = 644;
		}
		imgPlate = _plateObj.GetComponent<Image>();
		cvNum = _numObj.GetComponent<Canvas>();
		if (cvPlate != null)
		{
			cvNum.sortingOrder = 645;
		}
	...
	private void _onUpdateFade(float value)
	{
	}
