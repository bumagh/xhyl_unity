...
public class MSE_DeskPullDownListController : MonoBehaviour
{
	public static MSE_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[MSE_MB_Singleton<MSE_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<MSE_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<MSE_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > MSE_MB_Singleton<MSE_LobbyViewController>.GetInstance().curDeskIndex)
			{
				MSE_MB_Singleton<MSE_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < MSE_MB_Singleton<MSE_LobbyViewController>.GetInstance().curDeskIndex)
			{
				MSE_MB_Singleton<MSE_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
