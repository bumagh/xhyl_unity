...
public class TF_SceneBgMngr : MonoBehaviour
{
	public static TF_SceneBgMngr G_SceneBgMngr;
	...
	public static TF_SceneBgMngr GetSingleton()
	{
	...
	private void Start()
	{
		...
		Reset();
		if ((bool)TF_NetMngr.GetSingleton() && TF_NetMngr.GetSingleton().mSceneBg != -1)
		{
			indexScene = TF_NetMngr.GetSingleton().mSceneBg;
			SetScene(indexScene);
		}
	}
	...
	public void SetScene(int index)
	{
		...
		{
			TF_BulletPoolMngr.GetSingleton().mIsFireEnableBySvr = true;
		}
	}

	public void ChangeScene()
	{
		TF_MusicMngr.GetSingleton().PlayGameSound(TF_MusicMngr.GAME_SOUND.SOUND_CLEAR_SCENE);
		indexScene++;
		indexScene %= 3;
	...
	{
		TF_FishPoolMngr.GetSingleton().RemoveAllFish();
		TF_BulletPoolMngr.GetSingleton().mIsFireEnableBySvr = true;
