...
public class SHT_DeskPullDownListController : MonoBehaviour
{
	public static SHT_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[SHT_MB_Singleton<SHT_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<SHT_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<SHT_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > SHT_MB_Singleton<SHT_LobbyViewController>.GetInstance().curDeskIndex)
			{
				SHT_MB_Singleton<SHT_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < SHT_MB_Singleton<SHT_LobbyViewController>.GetInstance().curDeskIndex)
			{
				SHT_MB_Singleton<SHT_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
