...
public class ESP_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(ESP_Desk desk)
	{
		...
		_textMinCoin.text = ((!(ESP_MySqlConnection.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(ESP_MySqlConnection.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
