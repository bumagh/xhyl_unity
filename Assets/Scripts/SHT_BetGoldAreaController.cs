...
public class SHT_BetGoldAreaController : MonoBehaviour
{
	...
	private void Start()
	{
		_btnBetSmall.onClick.AddListener(SHT_MB_Singleton<SHT_DiceGameController2>.GetInstance().OnBtnBetSmall_Click);
		_btnBetMiddle.onClick.AddListener(SHT_MB_Singleton<SHT_DiceGameController2>.GetInstance().OnBtnBetMiddle_Click);
		_btnBetBig.onClick.AddListener(SHT_MB_Singleton<SHT_DiceGameController2>.GetInstance().OnBtnBetBig_Click);
	}
