...
public class CRL_DeskPullDownListController : MonoBehaviour
{
	public static CRL_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[CRL_MB_Singleton<CRL_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<CRL_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<CRL_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > CRL_MB_Singleton<CRL_LobbyViewController>.GetInstance().curDeskIndex)
			{
				CRL_MB_Singleton<CRL_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < CRL_MB_Singleton<CRL_LobbyViewController>.GetInstance().curDeskIndex)
			{
				CRL_MB_Singleton<CRL_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
