...
public class WHN_BetGoldAreaController : MonoBehaviour
{
	...
	private void Start()
	{
		_btnBetSmall.onClick.AddListener(WHN_MB_Singleton<WHN_DiceGameController2>.GetInstance().OnBtnBetSmall_Click);
		_btnBetMiddle.onClick.AddListener(WHN_MB_Singleton<WHN_DiceGameController2>.GetInstance().OnBtnBetMiddle_Click);
		_btnBetBig.onClick.AddListener(WHN_MB_Singleton<WHN_DiceGameController2>.GetInstance().OnBtnBetBig_Click);
	}
