...
public class PTM_SettingsController : PTM_MB_Singleton<PTM_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (PTM_MB_Singleton<PTM_SettingsController>._instance == null)
		{
			PTM_MB_Singleton<PTM_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_LobbyBGM, 0);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_DiceBGM, 0);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_MaryBGM, 0);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Dealer, 0);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Guys, 0);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Major, 0);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Mary, 0);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_DiceBGM, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_MaryBGM, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Dealer, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Guys, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Major, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Mary, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			PTM_SoundManager.Instance.PlayClickAudio();
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_LobbyBGM, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_DiceBGM, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_MaryBGM, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Dealer, 1);
			PTM_SoundManager.Instance.SetAudioSourceVolum(PTM_SoundManager.Instance.ads_Guys, 1);
