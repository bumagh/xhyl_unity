...
public class FK3_KeyValueList<K, V> : IList, IEnumerable, ICollection
{
	...
	public int Count => valList.Count;
	...
	public FK3_KeyValueList()
	{
	}

	public FK3_KeyValueList(ref List<K> keyListRef, ref List<V> valListRef)
	{
		keyList = keyListRef;
		valList = valListRef;
	}

	public FK3_KeyValueList(FK3_KeyValueList<K, V> otherKeyValueList)
	{
	...
	{
		throw new NotImplementedException("Use FK3_KeyValueList[key] = value or insert");
	}
	...
	public void CopyTo(FK3_KeyValueList<K, V> otherKeyValueList, int index)
	{
	...
	public void AddRange(FK3_KeyValueList<K, V> otherKeyValueList)
	{
