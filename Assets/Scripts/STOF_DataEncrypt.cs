...
public class STOF_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static STOF_DataEncrypt _MyDataEncrypt;
	...
	public static STOF_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			STOF_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
