...
public class LLD_SettingsController : LLD_MB_Singleton<LLD_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (LLD_MB_Singleton<LLD_SettingsController>._instance == null)
		{
			LLD_MB_Singleton<LLD_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_LobbyBGM, 0);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_DiceBGM, 0);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_MaryBGM, 0);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Dealer, 0);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Guys, 0);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Major, 0);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Mary, 0);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_DiceBGM, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_MaryBGM, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Dealer, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Guys, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Major, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Mary, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			LLD_SoundManager.Instance.PlayClickAudio();
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_LobbyBGM, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_DiceBGM, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_MaryBGM, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Dealer, 1);
			LLD_SoundManager.Instance.SetAudioSourceVolum(LLD_SoundManager.Instance.ads_Guys, 1);
