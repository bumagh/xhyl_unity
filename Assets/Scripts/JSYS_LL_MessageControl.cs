...
public class JSYS_LL_MessageControl : MonoBehaviour
{
	private Mutex m_MessageControlMutex;

	private Queue m_MsgQueue;

	private static JSYS_LL_MessageControl _MyMessageControl;

	public static JSYS_LL_MessageControl GetSingleton()
	{
