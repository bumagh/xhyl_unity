...
public class SHT_SettingsController : SHT_MB_Singleton<SHT_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (SHT_MB_Singleton<SHT_SettingsController>._instance == null)
		{
			SHT_MB_Singleton<SHT_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_LobbyBGM, 0);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_DiceBGM, 0);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_MaryBGM, 0);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Dealer, 0);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Guys, 0);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Major, 0);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Mary, 0);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_DiceBGM, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_MaryBGM, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Dealer, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Guys, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Major, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Mary, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			SHT_SoundManager.Instance.PlayClickAudio();
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_LobbyBGM, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_DiceBGM, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_MaryBGM, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Dealer, 1);
			SHT_SoundManager.Instance.SetAudioSourceVolum(SHT_SoundManager.Instance.ads_Guys, 1);
