...
namespace QZNiuNiu.TextVerticalGradientThreeColor
{
	[RequireComponent(typeof(Text))]
	public class FK3_TextVerticalGradientThreeColor : BaseMeshEffect
	{
		...
		protected FK3_TextVerticalGradientThreeColor()
		{
		}
