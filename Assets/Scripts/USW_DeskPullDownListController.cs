...
public class USW_DeskPullDownListController : MonoBehaviour
{
	public static USW_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[USW_MB_Singleton<USW_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<USW_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<USW_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > USW_MB_Singleton<USW_LobbyViewController>.GetInstance().curDeskIndex)
			{
				USW_MB_Singleton<USW_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < USW_MB_Singleton<USW_LobbyViewController>.GetInstance().curDeskIndex)
			{
				USW_MB_Singleton<USW_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
