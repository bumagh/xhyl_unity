...
public class FishPathMgr : BaseBehavior<FullSerializerSerializer>
{
	private static FishPathMgr s_instance;
	...
	public PathManager GetPathById(int id)
	{
		...
		if (value == null)
		{
			UnityEngine.Debug.Log(HW2_LogHelper.Red($"fishPath[id:{id}] not found"));
		}
		return value;
	}
