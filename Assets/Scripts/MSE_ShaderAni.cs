...
public class MSE_ShaderAni
{
	...
	public MSE_ShaderAni(Material mat)
	{
		this.mat = mat;
	}
	...
	public IEnumerator AniStart(MSE_CellType startType)
	{
		yield return null;
		SetUseShader(1);
		float acc = 25f;
	...
	public IEnumerator AniStop(MSE_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
