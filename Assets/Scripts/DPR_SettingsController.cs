...
public class DPR_SettingsController : DPR_MB_Singleton<DPR_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (DPR_MB_Singleton<DPR_SettingsController>._instance == null)
		{
			DPR_MB_Singleton<DPR_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_LobbyBGM, 0);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_DiceBGM, 0);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_MaryBGM, 0);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Dealer, 0);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Guys, 0);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Major, 0);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Mary, 0);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_DiceBGM, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_MaryBGM, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Dealer, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Guys, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Major, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Mary, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			DPR_SoundManager.Instance.PlayClickAudio();
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_LobbyBGM, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_DiceBGM, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_MaryBGM, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Dealer, 1);
			DPR_SoundManager.Instance.SetAudioSourceVolum(DPR_SoundManager.Instance.ads_Guys, 1);
