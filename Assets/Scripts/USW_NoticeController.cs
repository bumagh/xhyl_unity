...
public class USW_NoticeController : USW_MB_Singleton<USW_NoticeController>
{
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			USW_MB_Singleton<USW_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
