...
public class WHN_ShaderAni
{
	...
	public WHN_ShaderAni(Material mat)
	{
		this.mat = mat;
	}
	...
	public IEnumerator AniStart(WHN_CellType startType)
	{
		yield return null;
		SetUseShader(1);
		float acc = 25f;
	...
	public IEnumerator AniStop(WHN_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
