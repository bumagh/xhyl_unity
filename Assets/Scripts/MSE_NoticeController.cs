...
public class MSE_NoticeController : MSE_MB_Singleton<MSE_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			MSE_MB_Singleton<MSE_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
