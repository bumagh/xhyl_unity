...
public class SHT_ShaderAni
{
	...
	public SHT_ShaderAni(Material mat)
	{
		this.mat = mat;
	}
	...
	public IEnumerator AniStart(SHT_CellType startType)
	{
		yield return null;
		SetUseShader(1);
		float acc = 25f;
	...
	public IEnumerator AniStop(SHT_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
