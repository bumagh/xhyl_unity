...
public class PTM_ClientSocket
{
	...
	public Action<int, int, PTM_ClientSocket> checkTimeoutHandler;
	...
	public PTM_ClientSocket(bool useTcpClient)
	{
	...
	{
		UnityEngine.Debug.LogError("链接: " + host + "  " + port);
		try
		{
