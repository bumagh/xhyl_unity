...
public class PTM_BetGoldAreaController : MonoBehaviour
{
	...
	private void Start()
	{
		_btnBetSmall.onClick.AddListener(PTM_MB_Singleton<PTM_DiceGameController2>.GetInstance().OnBtnBetSmall_Click);
		_btnBetMiddle.onClick.AddListener(PTM_MB_Singleton<PTM_DiceGameController2>.GetInstance().OnBtnBetMiddle_Click);
		_btnBetBig.onClick.AddListener(PTM_MB_Singleton<PTM_DiceGameController2>.GetInstance().OnBtnBetBig_Click);
	}
