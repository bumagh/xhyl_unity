...
public class BaiJiaLe_MessageControl : MonoBehaviour
{
	private Mutex m_MessageControlMutex;

	private Queue m_MsgQueue;

	private static BaiJiaLe_MessageControl _MyMessageControl;

	public static BaiJiaLe_MessageControl GetSingleton()
	{
