...
namespace SWS
{
	public class PathManager : MonoBehaviour
	{
		...
		public Color color2 = new Color(1f, 47f / 51f, 4f / 255f, 0.5f);
		...
		public Vector3 GetBeginDirection()
		{
			...
			Vector3[] pathPoints = GetPathPoints();
			left = pathPoints[1] - pathPoints[0];
			left = Vector3.Normalize(left);
			Quaternion quaternion = Quaternion.FromToRotation(Vector3.left, left);
			return left;
		}

		public Quaternion GetBeginRotation(Vector3 up)
		{
			Vector3 beginDirection = GetBeginDirection();
			return Quaternion.FromToRotation(up, beginDirection);
		}
