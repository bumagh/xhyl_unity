...
namespace ProtoBuf
{
	public static class BclHelpers
	{
		...
		public static void WriteDateTime(DateTime value, ProtoWriter dest)
		{
			...
			TimeSpan timeSpan = (wireType != WireType.StartGroup && wireType != WireType.String) ? (value - EpochOrigin) : ((value == DateTime.MaxValue) ? TimeSpan.MaxValue : ((!(value == DateTime.MinValue)) ? (value - EpochOrigin) : TimeSpan.MinValue));
