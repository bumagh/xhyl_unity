		...
		private IProtoSerializer BuildSerializer()
		{
			...
			try
			{
				...
				if (member != null)
				{
					...
					{
						FieldInfo left2 = member as FieldInfo;
						if (!(left2 != null))
						{
