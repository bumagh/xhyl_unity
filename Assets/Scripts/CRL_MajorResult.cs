...
public class CRL_MajorResult
{
	...
	public CRL_MajorResult Init(int lineNum, int singleStake, int totalStake, Dictionary<string, object> dic, CRL_CellManager cSF_CellManager)
	{
