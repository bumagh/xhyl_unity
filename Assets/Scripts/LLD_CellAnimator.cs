...
public class LLD_CellAnimator : MonoBehaviour
{
	private STWM_SpiCell[] spiCells;

	private LLD_CellManager cSF_CellManager;

	public LLD_CellAnim Anim
	{
		get;
		set;
	}

	public LLD_ScrollAnim AnimScroll
	{
		get;
		set;
	}
	...
	private void Awake()
	{
		Anim = base.transform.GetComponent<LLD_CellAnim>();
		AnimScroll = base.transform.Find("Scroll").GetComponent<LLD_ScrollAnim>();
		if (cSF_CellManager == null)
		{
			cSF_CellManager = base.transform.parent.GetComponent<LLD_CellManager>();
		}
