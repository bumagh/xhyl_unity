...
internal class FK3_XTaskManager : MonoBehaviour
{
	...
	private static FK3_XTaskManager singleton;

	public static TaskState CreateTask(IEnumerator coroutine)
	{
		if (singleton == null)
		{
			GameObject gameObject = new GameObject("FK3_XTaskManager");
			singleton = gameObject.AddComponent<FK3_XTaskManager>();
		}
