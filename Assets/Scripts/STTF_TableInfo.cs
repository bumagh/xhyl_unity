public class STTF_TableInfo : STTF_BaseItem
{
	...
	public STTF_TableInfo()
	{
	}

	public STTF_TableInfo(STTF_FishDesk netDesk)
	{
		mId = netDesk.id;
		mName = netDesk.name;
	...
	public static int compareById(STTF_TableInfo t1, STTF_TableInfo t2)
	{
