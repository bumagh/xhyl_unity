...
public class LKB_DicesController : MonoBehaviour
{
	...
	public void ShowBigDices(int dice1, int dice2, LKB_BetDiceType type)
	{
	...
	public IEnumerator WaitAndShowBigDices(float waitTime, int dice1, int dice2, LKB_BetDiceType type)
	{
		yield return new WaitForSeconds(waitTime);
