...
public class LL_All_ShanDian : MonoBehaviour
{
	...
	public void OnFly()
	{
		LL_MusicMngr.GetSingleton().PlayEffectSound(LL_MusicMngr.MUSIC_EFFECT_MUSIC.Effect_ALL_LIGHTING_X2_FLY);
	}

	public void OnFlyEnd()
	{
		LL_MusicMngr.GetSingleton().PlayEffectSound(LL_MusicMngr.MUSIC_EFFECT_MUSIC.Effect_ALL_LIGHTING_X2_FLYEND);
	}
}
