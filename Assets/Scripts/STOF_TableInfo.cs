public class STOF_TableInfo : STOF_BaseItem
{
	...
	public STOF_TableInfo()
	{
	}

	public STOF_TableInfo(STOF_FishDesk netDesk)
	{
		if (netDesk != null)
		{
			mId = netDesk.id;
	...
	public static int compareById(STOF_TableInfo t1, STOF_TableInfo t2)
	{
