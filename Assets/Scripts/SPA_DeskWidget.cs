...
public class SPA_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(SPA_Desk desk)
	{
		...
		_textMinCoin.text = ((!(SPA_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(SPA_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
