...
public class DPR_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(DPR_Desk desk)
	{
		...
		_textMinCoin.text = ((!(DPR_MySqlConnection.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(DPR_MySqlConnection.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
