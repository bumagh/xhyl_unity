...
public class DataEncrypt
{
	...
	private string IVKey = "dHjWxY506jk0K7W8";
	...
	public byte[] Decrypt(byte[] toDecrypt)
	{
		...
		cryptoTransform = rijndaelManaged2.CreateDecryptor();
		...
		{
			Debuger.LogError("====cryptoTransform为空====");
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
}
