...
public class FK3_SoundMgr : FK3_Singleton<FK3_SoundMgr>
{
	...
	{
		GameObject gameObject = new GameObject("FK3_SoundMgr");
		UnityEngine.Object.DontDestroyOnLoad(gameObject);
		FK3_GVars.dontDestroyOnLoadList.Add(gameObject);
		_init(gameObject);
	}
}
