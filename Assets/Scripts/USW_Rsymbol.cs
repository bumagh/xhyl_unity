...
public class USW_Rsymbol
{
	...
	public USW_Rsymbol(Transform tran, int idx, USW_RollSymbol RS, USW_Symdata data, Action stopaction)
	{
		Rs = RS;
		Tran = tran;
		Data = data;
	...
	{
		frame = frameimg;
		seq_frame = frame.USW_PlayAni("icon_guangxiao{0:0}", 1, 15f);
		seq_ani = img.USW_PlayAni("spirit_big_{0:00}", 0, 15f);
		isbig = true;
	}
