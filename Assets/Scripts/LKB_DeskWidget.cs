...
public class LKB_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(LKB_Desk desk)
	{
		...
		_textMinCoin.text = ((!(LKB_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(LKB_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
