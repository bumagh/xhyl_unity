...
public class USW_SettingsController : USW_MB_Singleton<USW_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (USW_MB_Singleton<USW_SettingsController>._instance == null)
		{
			USW_MB_Singleton<USW_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_LobbyBGM, 0);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_DiceBGM, 0);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_MaryBGM, 0);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Dealer, 0);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Guys, 0);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Major, 0);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Mary, 0);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_DiceBGM, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_MaryBGM, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Dealer, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Guys, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Major, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Mary, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			USW_SoundManager.Instance.PlayClickAudio();
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_LobbyBGM, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_DiceBGM, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_MaryBGM, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Dealer, 1);
			USW_SoundManager.Instance.SetAudioSourceVolum(USW_SoundManager.Instance.ads_Guys, 1);
