...
public class FK3_ClientSocket
{
	...
	public Action<int, int, FK3_ClientSocket> checkTimeoutHandler;
	...
	public FK3_ClientSocket(bool useTcpClient)
	{
	...
	public void Close()
	{
		...
		UnityEngine.Debug.Log("====socket关闭====");
	}
