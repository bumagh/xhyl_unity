...
public class CSF_ScrollAnim : MonoBehaviour
{
	...
	private float[] posScroll = new float[11]
	{
		15f,
		805f,
		565f,
	...
	public IEnumerator AniStart(CSF_CellType startType)
	{
		yield return null;
		bRoll = true;
		float acc = 25f;
	...
	public IEnumerator AniStop(CSF_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
