...
public class LLD_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(LLD_Desk desk)
	{
		...
		_textMinCoin.text = ((!(LLD_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(LLD_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
