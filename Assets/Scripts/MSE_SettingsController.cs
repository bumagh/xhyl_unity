...
public class MSE_SettingsController : MSE_MB_Singleton<MSE_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (MSE_MB_Singleton<MSE_SettingsController>._instance == null)
		{
			MSE_MB_Singleton<MSE_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_LobbyBGM, 0);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_DiceBGM, 0);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_MaryBGM, 0);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Dealer, 0);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Guys, 0);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Major, 0);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Mary, 0);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_DiceBGM, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_MaryBGM, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Dealer, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Guys, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Major, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Mary, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			MSE_SoundManager.Instance.PlayClickAudio();
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_LobbyBGM, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_DiceBGM, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_MaryBGM, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Dealer, 1);
			MSE_SoundManager.Instance.SetAudioSourceVolum(MSE_SoundManager.Instance.ads_Guys, 1);
