...
public class ESP_NoticeController : ESP_MB_Singleton<ESP_NoticeController>
{
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			ESP_MB_Singleton<ESP_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
	...
	{
		float y;
		switch (ESP_MySqlConnection.curView)
		{
		case "MajorGame":
			y = 314f;
			break;
