...
public class CRL_SettingsController : CRL_MB_Singleton<CRL_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (CRL_MB_Singleton<CRL_SettingsController>._instance == null)
		{
			CRL_MB_Singleton<CRL_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_LobbyBGM, 0);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_DiceBGM, 0);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_MaryBGM, 0);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Dealer, 0);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Guys, 0);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Major, 0);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Mary, 0);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_DiceBGM, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_MaryBGM, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Dealer, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Guys, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Major, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Mary, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			CRL_SoundManager.Instance.PlayClickAudio();
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_LobbyBGM, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_DiceBGM, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_MaryBGM, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Dealer, 1);
			CRL_SoundManager.Instance.SetAudioSourceVolum(CRL_SoundManager.Instance.ads_Guys, 1);
