public class ESP_HitLineComputer
{
	...
	public ESP_HitLineComputer(int lineIndex, int[] cells)
	{
		this.cells = cells;
		winType = ESP_WinLineType.None;
		dragonNum = 0;
		multiple = 0;
		cellType = ESP_CellType.None;
		this.lineIndex = lineIndex;
	}

	public static int CalculateHitNum(ESP_WinLineType winlinetype)
	{
		switch (winlinetype)
		{
		case ESP_WinLineType.Left2:
			return 2;
		case ESP_WinLineType.Left3:
			return 3;
		case ESP_WinLineType.Left4:
			return 4;
		case ESP_WinLineType.Full:
			return 5;
		default:
			return 0;
		}
