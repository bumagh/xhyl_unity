...
{
	internal class JSYS_LL_Parameter
	{
		public static JSYS_LL_Parameter G_Parameter = null;
		...
		public static JSYS_LL_Parameter GetSingleton()
		{
			if (G_Parameter == null)
			{
				G_Parameter = new JSYS_LL_Parameter();
				return G_Parameter;
			}
			return G_Parameter;
		}
		...
		public string GetSvrIP()
		{
			...
			return JSYS_LL_GameInfo.getInstance().IP;
		}
	}
}
