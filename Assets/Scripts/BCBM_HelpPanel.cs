...
public class BCBM_HelpPanel : MonoBehaviour
{
	...
	protected BCBM_UICheckbox mEGameCenterTag;
	...
	private void Start()
	{
		...
		mEGameCenterTag = base.transform.Find("Tag").Find("EGameCenterDescriptionTag").GetComponent<BCBM_UICheckbox>();
