...
public class WHN_NoticeController : WHN_MB_Singleton<WHN_NoticeController>
{
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			WHN_MB_Singleton<WHN_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
