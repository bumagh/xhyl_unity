public class STQM_TableInfo : STQM_BaseItem
{
	...
	public STQM_TableInfo()
	{
	}

	public STQM_TableInfo(STQM_FishDesk netDesk)
	{
		mId = netDesk.id;
		mName = netDesk.name;
	...
	public static int compareById(STQM_TableInfo t1, STQM_TableInfo t2)
	{
