...
public class USW_SoundManager : MonoBehaviour
{
	public static USW_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(USW_CellType celltype, int ImgNum = 0)
	{
