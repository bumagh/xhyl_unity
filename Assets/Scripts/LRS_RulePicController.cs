...
public class LRS_RulePicController : MonoBehaviour, IEventSystemHandler, IBeginDragHandler, IEndDragHandler
{
	...
	public void Show()
	{
		...
		language = ((!(LRS_GVars.language == "zh")) ? 1 : 0);
		DotColorSet();
		ImgRulesSet();
