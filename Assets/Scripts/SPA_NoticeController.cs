...
public class SPA_NoticeController : SPA_MB_Singleton<SPA_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			SPA_MB_Singleton<SPA_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
