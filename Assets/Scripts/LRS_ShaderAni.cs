...
public class LRS_ShaderAni
{
	...
	public LRS_ShaderAni(Material mat)
	{
		this.mat = mat;
	}
	...
	public IEnumerator AniStart(LRS_CellType startType)
	{
		yield return null;
		SetUseShader(1);
		float acc = 25f;
	...
	public IEnumerator AniStop(LRS_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
