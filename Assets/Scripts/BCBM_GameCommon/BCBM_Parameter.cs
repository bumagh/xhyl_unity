...
{
	internal class BCBM_Parameter
	{
		public static BCBM_Parameter G_Parameter = null;
		...
		public static BCBM_Parameter GetSingleton()
		{
			if (G_Parameter == null)
			{
				G_Parameter = new BCBM_Parameter();
				return G_Parameter;
			}
			return G_Parameter;
		}
		...
		public string GetSvrIP()
		{
			...
			return BCBM_GameInfo.getInstance().IP;
		}
	}
}
