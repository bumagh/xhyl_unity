...
public class USW_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(USW_Desk desk)
	{
		...
		_textMinCoin.text = ((!(USW_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(USW_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
