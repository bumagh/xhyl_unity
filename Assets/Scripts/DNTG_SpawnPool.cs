...
public sealed class DNTG_SpawnPool : MonoBehaviour, IList<Transform>, ICollection<Transform>, IEnumerable<Transform>, IEnumerable
{
	...
	public List<DNTG_PrefabPool> _perPrefabPoolOptions = new List<DNTG_PrefabPool>();
	...
	public DNTG_PrefabsDict prefabs = new DNTG_PrefabsDict();

	public Dictionary<object, bool> _editorListItemStates = new Dictionary<object, bool>();

	private List<DNTG_PrefabPool> _prefabPools = new List<DNTG_PrefabPool>();
	...
	public Dictionary<string, DNTG_PrefabPool> prefabPools
	{
		get
		{
			Dictionary<string, DNTG_PrefabPool> dictionary = new Dictionary<string, DNTG_PrefabPool>();
			foreach (DNTG_PrefabPool prefabPool in _prefabPools)
			{
	...
	private void Awake()
	{
		...
		foreach (DNTG_PrefabPool perPrefabPoolOption in _perPrefabPoolOptions)
		{
		...
		DNTG_PoolManager.Pools.Add(this);
	}
	...
	private void OnDestroy()
	{
		...
		DNTG_PoolManager.Pools.Remove(this);
		StopAllCoroutines();
		_spawned.Clear();
		foreach (DNTG_PrefabPool prefabPool in _prefabPools)
		{
	...
	public void CreatePrefabPool(DNTG_PrefabPool prefabPool)
	{
	...
	public Transform Spawn(Transform prefab, Vector3 pos, Quaternion rot)
	{
		...
		DNTG_PrefabPool dNTG_PrefabPool = new DNTG_PrefabPool(prefab);
		CreatePrefabPool(dNTG_PrefabPool);
		transform = dNTG_PrefabPool.SpawnInstance(pos, rot);
		transform.parent = group;
		_spawned.Add(transform);
		return transform;
	}
