...
{
	public class FK3_ConsoleProRemoteServer : MonoBehaviour
	{
		public class HTTPContext
		{
			...
			public string Command => WWW.UnEscapeURL(context.Request.Url.AbsolutePath);
		...
		private void Awake()
		{
			...
			UnityEngine.Debug.Log("Starting Console Pro Server on port : " + port);
