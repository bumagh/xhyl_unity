...
public class SPA_MajorResult
{
	...
	public SPA_MajorResult Init(int lineNum, int singleStake, int totalStake, Dictionary<string, object> dic, SPA_CellManager cSF_CellManager)
	{
