...
public class PHG_Rsymbol
{
	...
	public PHG_Rsymbol(Transform tran, int idx, PHG_RollSymbol RS, PHG_Symdata data, Action stopaction)
	{
		Rs = RS;
		Tran = tran;
		Data = data;
	...
	{
		frame = frameimg;
		seq_frame = frame.PHG_PlayAni("icon_guangxiao{0:0}", 1, 15f);
		seq_ani = img.PHG_PlayAni("spirit_big_{0:00}", 0, 15f);
		isbig = true;
	}
