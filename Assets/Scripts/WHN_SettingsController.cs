...
public class WHN_SettingsController : WHN_MB_Singleton<WHN_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (WHN_MB_Singleton<WHN_SettingsController>._instance == null)
		{
			WHN_MB_Singleton<WHN_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_LobbyBGM, 0);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_DiceBGM, 0);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_MaryBGM, 0);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Dealer, 0);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Guys, 0);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Major, 0);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Mary, 0);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_DiceBGM, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_MaryBGM, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Dealer, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Guys, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Major, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Mary, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			WHN_SoundManager.Instance.PlayClickAudio();
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_LobbyBGM, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_DiceBGM, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_MaryBGM, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Dealer, 1);
			WHN_SoundManager.Instance.SetAudioSourceVolum(WHN_SoundManager.Instance.ads_Guys, 1);
