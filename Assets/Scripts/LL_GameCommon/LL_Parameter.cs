...
{
	internal class LL_Parameter
	{
		public static LL_Parameter G_Parameter = null;
		...
		public static LL_Parameter GetSingleton()
		{
			if (G_Parameter == null)
			{
				G_Parameter = new LL_Parameter();
				return G_Parameter;
			}
			return G_Parameter;
		}
		...
		public string GetSvrIP()
		{
			...
			return LL_GameInfo.getInstance().IP;
		}
	}
}
