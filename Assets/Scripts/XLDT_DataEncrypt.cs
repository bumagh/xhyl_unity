...
public class XLDT_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static XLDT_DataEncrypt _MyDataEncrypt;
	...
	public static XLDT_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			XLDT_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
}
