...
public class CSF_DeskPullDownListController : MonoBehaviour
{
	public static CSF_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[CSF_MB_Singleton<CSF_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<CSF_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<CSF_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > CSF_MB_Singleton<CSF_LobbyViewController>.GetInstance().curDeskIndex)
			{
				CSF_MB_Singleton<CSF_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < CSF_MB_Singleton<CSF_LobbyViewController>.GetInstance().curDeskIndex)
			{
				CSF_MB_Singleton<CSF_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
