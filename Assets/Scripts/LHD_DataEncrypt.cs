...
public class LHD_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static LHD_DataEncrypt _MyDataEncrypt;
	...
	public static LHD_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			LHD_SafeTools.LHD_SafeTools.Adjust_String(innerText),
			innerText2
		};
	}
}
