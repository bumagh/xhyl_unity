...
public class LRS_DeskPullDownListController : MonoBehaviour
{
	public static LRS_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[LRS_MB_Singleton<LRS_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<LRS_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<LRS_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > LRS_MB_Singleton<LRS_LobbyViewController>.GetInstance().curDeskIndex)
			{
				LRS_MB_Singleton<LRS_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < LRS_MB_Singleton<LRS_LobbyViewController>.GetInstance().curDeskIndex)
			{
				LRS_MB_Singleton<LRS_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
