...
public class BCBM_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static BCBM_DataEncrypt _MyDataEncrypt;
	...
	public static BCBM_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			BCBM_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
}
