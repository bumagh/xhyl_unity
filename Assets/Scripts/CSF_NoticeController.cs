...
public class CSF_NoticeController : CSF_MB_Singleton<CSF_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			CSF_MB_Singleton<CSF_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
	...
	{
		float y;
		switch (CSF_MySqlConnection.curView)
		{
		case "MajorGame":
			y = 314f;
			break;
