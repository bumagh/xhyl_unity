...
public class LRS_BetGoldAreaController : MonoBehaviour
{
	...
	private void Start()
	{
		_btnBetSmall.onClick.AddListener(LRS_MB_Singleton<LRS_DiceGameController2>.GetInstance().OnBtnBetSmall_Click);
		_btnBetMiddle.onClick.AddListener(LRS_MB_Singleton<LRS_DiceGameController2>.GetInstance().OnBtnBetMiddle_Click);
		_btnBetBig.onClick.AddListener(LRS_MB_Singleton<LRS_DiceGameController2>.GetInstance().OnBtnBetBig_Click);
	}
