...
public class DPR_NoticeController : DPR_MB_Singleton<DPR_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			DPR_MB_Singleton<DPR_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
	...
	{
		float y;
		switch (DPR_MySqlConnection.curView)
		{
		case "MajorGame":
			y = 314f;
			break;
