...
namespace BansheeGz.BGSpline.Curve
{
	public class BGCurvePointComponent : MonoBehaviour, BGCurvePointI
	{
		...
		public BGCurve Curve => point.Curve;

		public Vector3 PositionLocal
		{
			get
			{
				return point.PositionLocal;
			}
			set
			{
				point.PositionLocal = value;
			}
		}
		...
		public Vector3 PositionLocalTransformed
		{
			get
			{
				return point.PositionLocalTransformed;
			}
			set
			{
				point.PositionLocalTransformed = value;
			}
		}
		...
		public Vector3 PositionWorld
		{
			get
			{
				return point.PositionWorld;
			}
			set
			{
				point.PositionWorld = value;
			}
		}
		...
		public Vector3 ControlFirstLocal
		{
			get
			{
				return point.ControlFirstLocal;
			}
			set
			{
				point.ControlFirstLocal = value;
			}
		}
		...
		public Vector3 ControlFirstLocalTransformed
		{
			get
			{
				return point.ControlFirstLocalTransformed;
			}
			set
			{
				point.ControlFirstLocalTransformed = value;
			}
		}
		...
		public Vector3 ControlFirstWorld
		{
			get
			{
				return point.ControlFirstWorld;
			}
			set
			{
				point.ControlFirstWorld = value;
			}
		}
		...
		public Vector3 ControlSecondLocal
		{
			get
			{
				return point.ControlSecondLocal;
			}
			set
			{
				point.ControlSecondLocal = value;
			}
		}
		...
		public Vector3 ControlSecondLocalTransformed
		{
			get
			{
				return point.ControlSecondLocalTransformed;
			}
			set
			{
				point.ControlSecondLocalTransformed = value;
			}
		}
		...
		public Vector3 ControlSecondWorld
		{
			get
			{
				return point.ControlSecondWorld;
			}
			set
			{
				point.ControlSecondWorld = value;
			}
		}
		...
		public BGCurvePoint.ControlTypeEnum ControlType
		{
			get
			{
				return point.ControlType;
			}
			set
			{
				point.ControlType = value;
			}
		}
		...
		public Transform PointTransform
		{
			get
			{
				return point.PointTransform;
			}
			set
			{
				point.PointTransform = value;
			}
		}

		public BGCurvePoint Point => point;
		...
		{
			return (point != null) ? (point + " as Component") : "no data";
		}
	}
}
