...
public class SPA_DeskPullDownListController : MonoBehaviour
{
	public static SPA_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[SPA_MB_Singleton<SPA_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<SPA_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<SPA_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > SPA_MB_Singleton<SPA_LobbyViewController>.GetInstance().curDeskIndex)
			{
				SPA_MB_Singleton<SPA_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < SPA_MB_Singleton<SPA_LobbyViewController>.GetInstance().curDeskIndex)
			{
				SPA_MB_Singleton<SPA_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
