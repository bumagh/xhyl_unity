...
public class PHG_BetGoldAreaController : MonoBehaviour
{
	...
	private void Start()
	{
		_btnBetSmall.onClick.AddListener(PHG_MB_Singleton<PHG_DiceGameController2>.GetInstance().OnBtnBetSmall_Click);
		_btnBetMiddle.onClick.AddListener(PHG_MB_Singleton<PHG_DiceGameController2>.GetInstance().OnBtnBetMiddle_Click);
		_btnBetBig.onClick.AddListener(PHG_MB_Singleton<PHG_DiceGameController2>.GetInstance().OnBtnBetBig_Click);
	}
