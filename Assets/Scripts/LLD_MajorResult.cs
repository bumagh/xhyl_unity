...
public class LLD_MajorResult
{
	...
	public LLD_MajorResult Init(int lineNum, int singleStake, int totalStake, Dictionary<string, object> dic, LLD_CellManager cSF_CellManager)
	{
