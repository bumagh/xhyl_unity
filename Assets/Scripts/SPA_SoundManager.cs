...
public class SPA_SoundManager : MonoBehaviour
{
	public static SPA_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(SPA_CellType celltype, int ImgNum = 0)
	{
		if (typeOfPlayEffect.Length > 0)
		{
