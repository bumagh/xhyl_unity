...
public class PHG_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(PHG_Desk desk)
	{
		...
		_textMinCoin.text = ((!(PHG_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(PHG_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
