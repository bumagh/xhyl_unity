...
public class DNTG_UserInfo : DNTG_BaseItem
{
	...
	public DNTG_UserInfo(DNTG_User netUser)
	{
		if (netUser != null)
		{
			mId = netUser.id;
	...
	public DNTG_UserInfo(int seatIndex, int photoId, string nickName)
	{
	...
	public static DNTG_UserInfo createOtherUser(DNTG_Seat netSeat)
	{
		DNTG_UserInfo dNTG_UserInfo = new DNTG_UserInfo(netSeat.user);
		dNTG_UserInfo.mSeatIndex = netSeat.seatId;
		dNTG_UserInfo.mIsExist = !netSeat.isFree;
		dNTG_UserInfo.mGunValue = netSeat.gunValue;
		return dNTG_UserInfo;
	}

	public static int compareBySeat(DNTG_UserInfo t1, DNTG_UserInfo t2)
	{
