...
namespace M__Mou.mobile.arcade.network
{
	public class FK3_DataEncrypt
	{
		...
		public byte[] Encrypt(byte[] toEncrypt)
		{
			...
			rijndaelManaged.IV = Encoding.UTF8.GetBytes("Qzh0Qxebwie8Kvse");
		...
		public string[] NetConnectGetRsaKey()
		{
			...
			return new string[2]
			{
				FK3_SafeTools.Adjust_String_1(innerText),
				innerText2
			};
		}
		...
		public byte[] CompressBytes(byte[] SourceByte)
		{
			try
			{
				...
				Stream stream = CompressStream(sourceStream);
