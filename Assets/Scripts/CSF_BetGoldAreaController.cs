...
public class CSF_BetGoldAreaController : MonoBehaviour
{
	...
	public IEnumerator SingleBetImageBlinkAni(CSF_BetDiceType type)
	{
	...
	public void SetSingleBetImage(CSF_BetDiceType type, bool isEnable = true)
	{
	...
	public void ShowBet(CSF_BetDiceType type, int betNum)
	{
		SetGoldLayerEnable(isEnable: true);
	...
	private void _adjustGoldLayerPosition(CSF_BetDiceType type)
	{
		switch (type)
		{
