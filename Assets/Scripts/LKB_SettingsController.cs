...
public class LKB_SettingsController : LKB_MB_Singleton<LKB_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (LKB_MB_Singleton<LKB_SettingsController>._instance == null)
		{
			LKB_MB_Singleton<LKB_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_LobbyBGM, 0);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_DiceBGM, 0);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_MaryBGM, 0);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Dealer, 0);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Guys, 0);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Major, 0);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Mary, 0);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_DiceBGM, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_MaryBGM, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Dealer, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Guys, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Major, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Mary, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			LKB_SoundManager.Instance.PlayClickAudio();
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_LobbyBGM, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_DiceBGM, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_MaryBGM, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Dealer, 1);
			LKB_SoundManager.Instance.SetAudioSourceVolum(LKB_SoundManager.Instance.ads_Guys, 1);
