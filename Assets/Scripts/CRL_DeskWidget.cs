...
public class CRL_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(CRL_Desk desk)
	{
		...
		_textMinCoin.text = ((!(CRL_MySqlConnection.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(CRL_MySqlConnection.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
