...
public class SPA_ScrollAnim : MonoBehaviour
{
	...
	private float[] posScroll = new float[15]
	{
		15f,
		805f,
		565f,
	...
	public IEnumerator AniStart(SPA_CellType startType)
	{
		yield return null;
		bRoll = true;
		float acc = 25f;
	...
	public IEnumerator AniStop(SPA_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
