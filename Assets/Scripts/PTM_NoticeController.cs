...
public class PTM_NoticeController : PTM_MB_Singleton<PTM_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			PTM_MB_Singleton<PTM_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
