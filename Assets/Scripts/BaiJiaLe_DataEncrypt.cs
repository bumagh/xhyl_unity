...
public class BaiJiaLe_DataEncrypt : MonoBehaviour
{
	...
	private static BaiJiaLe_DataEncrypt _MyDataEncrypt;

	public BaiJiaLe_DataEncrypt()
	{
	...
	public static BaiJiaLe_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			BaiJiaLe_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
