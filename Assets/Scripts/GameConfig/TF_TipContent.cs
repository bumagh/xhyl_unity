	...
	public class TF_TipContent
	{
		public static readonly string[][] contents = new string[2][]
		{
			...
			new string[22]
			{
				...
				"The current global state is banned",
				...
				"The seat has have a player, please re-select",
				"End of free experience",
