...
public class MSE_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(MSE_Desk desk)
	{
		...
		_textMinCoin.text = ((!(MSE_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(MSE_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
