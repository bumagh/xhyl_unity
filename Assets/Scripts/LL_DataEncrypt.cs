...
public class LL_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static LL_DataEncrypt _MyDataEncrypt;
	...
	public static LL_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			LL_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
}
