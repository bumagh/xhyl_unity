...
public class CRL_NoticeController : CRL_MB_Singleton<CRL_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			CRL_MB_Singleton<CRL_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
	...
	{
		float y;
		switch (CRL_MySqlConnection.curView)
		{
		case "MajorGame":
			y = 314f;
			break;
