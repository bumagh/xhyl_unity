...
public class STWM_NoticeController : STWM_MB_Singleton<STWM_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			STWM_MB_Singleton<STWM_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
