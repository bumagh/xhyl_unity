...
public class BCBM_All_ShanDian : MonoBehaviour
{
	...
	public void OnFly()
	{
		BCBM_MusicMngr.GetSingleton().PlayEffectSound(BCBM_MusicMngr.MUSIC_EFFECT_MUSIC.Effect_ALL_LIGHTING_X2_FLY);
	}

	public void OnFlyEnd()
	{
		BCBM_MusicMngr.GetSingleton().PlayEffectSound(BCBM_MusicMngr.MUSIC_EFFECT_MUSIC.Effect_ALL_LIGHTING_X2_FLYEND);
	}
}
