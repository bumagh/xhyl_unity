...
public class STMF_DataEncrypt : MonoBehaviour
{
    private string key = "none";

    private string IVKey = "Qzh0Qxebwie8Kvse";

    private static STMF_DataEncrypt _MyDataEncrypt;
    ...
    public static STMF_DataEncrypt GetSingleton()
    {
    ...
    public string[] NetConnectGetRsaKey()
    {
        ...
        return new string[2]
        {
            STMF_SafeTools.Adjust_String_1(innerText),
            innerText2
        };
    }
