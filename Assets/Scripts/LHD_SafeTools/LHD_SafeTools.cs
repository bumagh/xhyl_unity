...
namespace LHD_SafeTools
{
	public class LHD_SafeTools
	{
		public static string Adjust_String(string source)
		{
			return (string)GetValue(IE_Adjust_String(source), toEnd: true);
		}

		private static IEnumerator IE_Adjust_String(string source)
		{
