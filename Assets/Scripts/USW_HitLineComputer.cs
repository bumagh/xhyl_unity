public class USW_HitLineComputer
{
	...
	public USW_HitLineComputer(int lineIndex, int[] cells)
	{
		this.cells = cells;
		winType = USW_WinLineType.None;
		dragonNum = 0;
		multiple = 0;
		cellType = USW_CellType.None;
		this.lineIndex = lineIndex;
	}

	public static int CalculateHitNum(USW_WinLineType winlinetype)
	{
		switch (winlinetype)
		{
		case USW_WinLineType.Left2:
			return 2;
		case USW_WinLineType.Left3:
			return 3;
		case USW_WinLineType.Left4:
			return 4;
		case USW_WinLineType.Full:
			return 5;
		default:
			return 0;
		}
