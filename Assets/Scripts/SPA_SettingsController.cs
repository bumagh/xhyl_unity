...
public class SPA_SettingsController : SPA_MB_Singleton<SPA_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (SPA_MB_Singleton<SPA_SettingsController>._instance == null)
		{
			SPA_MB_Singleton<SPA_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_LobbyBGM, 0);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_DiceBGM, 0);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_MaryBGM, 0);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Dealer, 0);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Guys, 0);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Major, 0);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Mary, 0);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_DiceBGM, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_MaryBGM, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Dealer, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Guys, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Major, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Mary, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			SPA_SoundManager.Instance.PlayClickAudio();
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_LobbyBGM, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_DiceBGM, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_MaryBGM, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Dealer, 1);
			SPA_SoundManager.Instance.SetAudioSourceVolum(SPA_SoundManager.Instance.ads_Guys, 1);
