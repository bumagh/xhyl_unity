...
public class DNTG_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static DNTG_DataEncrypt _MyDataEncrypt;
	...
	public static DNTG_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			DNTG_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
