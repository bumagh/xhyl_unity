...
public class WHN_Rsymbol
{
	...
	public WHN_Rsymbol(Transform tran, int idx, WHN_RollSymbol RS, WHN_Symdata data, Action stopaction)
	{
		Rs = RS;
		Tran = tran;
		Data = data;
	...
	{
		frame = frameimg;
		seq_frame = frame.WHN_PlayAni("icon_guangxiao{0:0}", 1, 15f);
		seq_ani = img.WHN_PlayAni("spirit_big_{0:00}", 0, 15f);
		isbig = true;
	}
