...
public class PTM_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(PTM_Desk desk)
	{
		...
		_textMinCoin.text = ((!(PTM_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(PTM_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
