...
public class TF_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static TF_DataEncrypt _MyDataEncrypt;
	...
	public static TF_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			TF_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
