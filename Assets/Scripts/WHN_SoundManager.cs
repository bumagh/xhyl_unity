...
public class WHN_SoundManager : MonoBehaviour
{
	public static WHN_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(WHN_CellType celltype, int ImgNum = 0)
	{
