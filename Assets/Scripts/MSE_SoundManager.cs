...
public class MSE_SoundManager : MonoBehaviour
{
	public static MSE_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(MSE_CellType celltype, int ImgNum = 0)
	{
