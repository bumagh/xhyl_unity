...
public class DPR_DeskPullDownListController : MonoBehaviour
{
	public static DPR_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[DPR_MB_Singleton<DPR_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<DPR_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<DPR_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > DPR_MB_Singleton<DPR_LobbyViewController>.GetInstance().curDeskIndex)
			{
				DPR_MB_Singleton<DPR_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < DPR_MB_Singleton<DPR_LobbyViewController>.GetInstance().curDeskIndex)
			{
				DPR_MB_Singleton<DPR_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
