...
{
	public class FK3_PrefabsDict : IDictionary<string, Transform>, IEnumerable, ICollection<KeyValuePair<string, Transform>>, IEnumerable<KeyValuePair<string, Transform>>
	{
