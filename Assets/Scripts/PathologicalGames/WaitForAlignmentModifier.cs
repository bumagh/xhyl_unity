...
namespace PathologicalGames
{
	...
	public class WaitForAlignmentModifier : TriggerEventProModifier
	{
		...
		{
			UnityEngine.Debug.LogWarning($"WaitForAlignementModifier on GameObject {base.name} has been deprecated. Replace the component with AngleLimitModifier (with the filterType set to 'Wait to Fire Event'). You can do this without losing your other settings by switching the Inspector tab to 'Debug' and changing the script field.");
