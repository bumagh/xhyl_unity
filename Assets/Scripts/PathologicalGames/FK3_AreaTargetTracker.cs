...
{
	[AddComponentMenu("Path-o-logical/TriggerEventPRO/TriggerEventPRO Area FK3_TargetTracker")]
	public class FK3_AreaTargetTracker : FK3_TargetTracker
	{
		...
		protected override void Awake()
		{
			...
			area = gameObject.AddComponent<FK3_Area>();
