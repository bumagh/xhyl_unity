public class SHT_HitLineComputer
{
	...
	public SHT_HitLineComputer(int lineIndex, int[] cells)
	{
		this.cells = cells;
		winType = SHT_WinLineType.None;
		dragonNum = 0;
		multiple = 0;
		cellType = SHT_CellType.None;
		this.lineIndex = lineIndex;
	}

	public static int CalculateHitNum(SHT_WinLineType winlinetype)
	{
		switch (winlinetype)
		{
		case SHT_WinLineType.Left2:
			return 2;
		case SHT_WinLineType.Left3:
			return 3;
		case SHT_WinLineType.Left4:
			return 4;
		case SHT_WinLineType.Full:
			return 5;
		default:
			return 0;
		}
