...
public class DK_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static DK_DataEncrypt _MyDataEncrypt;
	...
	public static DK_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			DK_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
