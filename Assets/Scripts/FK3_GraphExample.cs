...
public class FK3_GraphExample : MonoBehaviour
{
	...
	private void OnGUI()
	{
		...
		GUILayout.Label("    The code that logs the variables in this example is inside the script called \"FK3_GraphExample.cs\" inside the Examples folder.");
		GUILayout.Space(40f);
