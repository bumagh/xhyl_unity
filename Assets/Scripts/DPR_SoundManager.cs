...
public class DPR_SoundManager : MonoBehaviour
{
	public static DPR_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(DPR_CellType celltype, int ImgNum = 0)
	{
		if (typeOfPlayEffect.Length > 0)
		{
