...
public class DK_GameBtnsCtrl : MonoBehaviour
{
	[HideInInspector]
	...
	public void ShowBtns()
	{
		...
		base.transform.DOLocalMoveX(bShow ? (0f - (DK_SetCanvas.GetCanvasWidth() / 2f - GetComponent<RectTransform>().rect.width / 2f)) : (0f - (DK_SetCanvas.GetCanvasWidth() / 2f + GetComponent<RectTransform>().rect.width / 2f)), 0.5f);
	}
}
