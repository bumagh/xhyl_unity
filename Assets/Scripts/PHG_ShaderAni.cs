...
public class PHG_ShaderAni
{
	...
	public PHG_ShaderAni(Material mat)
	{
		this.mat = mat;
	}
	...
	public IEnumerator AniStart(PHG_CellType startType)
	{
		yield return null;
		SetUseShader(1);
		float acc = 25f;
	...
	public IEnumerator AniStop(PHG_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
