...
public class PHG_SoundManager : MonoBehaviour
{
	public static PHG_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(PHG_CellType celltype, int ImgNum = 0)
	{
		if (typeOfPlayEffect.Length > 0)
		{
