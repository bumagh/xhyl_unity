...
public class LL_HelpPanel : MonoBehaviour
{
	...
	protected LL_UICheckbox mEGameCenterTag;
	...
	private void Start()
	{
		...
		mEGameCenterTag = base.transform.Find("Tag").Find("EGameCenterDescriptionTag").GetComponent<LL_UICheckbox>();
