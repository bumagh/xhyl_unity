...
public class LLD_NoticeController : LLD_MB_Singleton<LLD_NoticeController>
{
	[SerializeField]
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			LLD_MB_Singleton<LLD_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
