...
public class CSF_SettingsController : CSF_MB_Singleton<CSF_SettingsController>
{
	[SerializeField]
	...
	private void Awake()
	{
		...
		if (CSF_MB_Singleton<CSF_SettingsController>._instance == null)
		{
			CSF_MB_Singleton<CSF_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			...
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_LobbyBGM, 0);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_DiceBGM, 0);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_MaryBGM, 0);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Dealer, 0);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Guys, 0);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Major, 0);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Mary, 0);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			if (language == 0)
			...
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_DiceBGM, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_MaryBGM, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Dealer, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Guys, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Major, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Mary, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			...
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			...
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		if (!CSF_MySqlConnection.tryLockOnePoint)
		{
			...
			CSF_SoundManager.Instance.PlayClickAudio();
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_LobbyBGM, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_DiceBGM, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_MaryBGM, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Dealer, 1);
			CSF_SoundManager.Instance.SetAudioSourceVolum(CSF_SoundManager.Instance.ads_Guys, 1);
