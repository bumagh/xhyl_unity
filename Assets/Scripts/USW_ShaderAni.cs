...
public class USW_ShaderAni
{
	...
	public USW_ShaderAni(Material mat)
	{
		this.mat = mat;
	}
	...
	public IEnumerator AniStart(USW_CellType startType)
	{
		yield return null;
		SetUseShader(1);
		float acc = 25f;
	...
	public IEnumerator AniStop(USW_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
