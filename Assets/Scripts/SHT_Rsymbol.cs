...
public class SHT_Rsymbol
{
	...
	public SHT_Rsymbol(Transform tran, int idx, SHT_RollSymbol RS, SHT_Symdata data, Action stopaction)
	{
		Rs = RS;
		Tran = tran;
		Data = data;
	...
	{
		frame = frameimg;
		seq_frame = frame.SHT_PlayAni("icon_guangxiao{0:0}", 1, 15f);
		seq_ani = img.SHT_PlayAni("spirit_big_{0:00}", 0, 15f);
		isbig = true;
	}
