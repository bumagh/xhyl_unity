...
public class JSYS_LL_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static JSYS_LL_DataEncrypt _MyDataEncrypt;
	...
	public static JSYS_LL_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			JSYS_LL_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
}
