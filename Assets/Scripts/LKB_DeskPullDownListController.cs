...
public class LKB_DeskPullDownListController : MonoBehaviour
{
	public static LKB_DeskPullDownListController Instance;
	...
	public void OnListButtonDown()
	{
		...
		imgBtns[LKB_MB_Singleton<LKB_LobbyViewController>.GetInstance().curDeskIndex].sprite = arrImgButton[1];
	...
	public void ChangeListHeightByDeskNum(int desknum, List<LKB_Desk> desklist)
	{
	...
	public void UpdateDeskInList(List<LKB_Desk> desks)
	{
	...
	public void SelectDeskByButton(int index)
	{
		if (bMoveFinished)
		{
			if (index > LKB_MB_Singleton<LKB_LobbyViewController>.GetInstance().curDeskIndex)
			{
				LKB_MB_Singleton<LKB_LobbyViewController>.GetInstance().ForceMoveDesksToRight(index);
			}
			else if (index < LKB_MB_Singleton<LKB_LobbyViewController>.GetInstance().curDeskIndex)
			{
				LKB_MB_Singleton<LKB_LobbyViewController>.GetInstance().ForceMoveDesksToLeft(index);
			}
