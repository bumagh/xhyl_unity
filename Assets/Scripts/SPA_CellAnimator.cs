...
public class SPA_CellAnimator : MonoBehaviour
{
	private STWM_SpiCell[] spiCells;

	private SPA_CellManager cSF_CellManager;

	public SPA_CellAnim Anim
	{
		get;
		set;
	}

	public SPA_ScrollAnim AnimScroll
	{
		get;
		set;
	}
	...
	private void Awake()
	{
		Anim = base.transform.GetComponent<SPA_CellAnim>();
		AnimScroll = base.transform.Find("Scroll").GetComponent<SPA_ScrollAnim>();
		if (cSF_CellManager == null)
		{
			cSF_CellManager = base.transform.parent.GetComponent<SPA_CellManager>();
		}
