...
public class CSF_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(CSF_Desk desk)
	{
		...
		_textMinCoin.text = ((!(CSF_MySqlConnection.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(CSF_MySqlConnection.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
