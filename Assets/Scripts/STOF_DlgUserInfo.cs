...
public class STOF_DlgUserInfo : MonoBehaviour
{
	[SerializeField]
	...
	[SerializeField]
	private STOF_UserIcon userIcon;
	...
	private STOF_DlgChat sptDlgChat;
	...
	public void ShowUserInfo(STOF_UserInfo user, int honor)
	{
		...
		txtLevel.text = "Lv" + user.Level + "(" + STOF_TitleName.names[user.Level - 1] + ")";
		if (honor < 1 || honor > 10)
		{
