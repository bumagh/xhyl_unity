...
public class BZJX_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static BZJX_DataEncrypt _MyDataEncrypt;
	...
	public static BZJX_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			BZJX_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
