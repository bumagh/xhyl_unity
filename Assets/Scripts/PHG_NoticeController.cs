...
public class PHG_NoticeController : PHG_MB_Singleton<PHG_NoticeController>
{
	...
	public void AddMessage(string msg)
	{
		...
		if (!m_isScrolling)
		{
			PHG_MB_Singleton<PHG_GameManager>.GetInstance().StartCoroutine(Scrolling());
		}
	}
