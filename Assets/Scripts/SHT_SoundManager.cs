...
public class SHT_SoundManager : MonoBehaviour
{
	public static SHT_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(SHT_CellType celltype, int ImgNum = 0)
	{
