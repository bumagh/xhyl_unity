...
public class DPR_MajorResult
{
	...
	public DPR_MajorResult Init(int lineNum, int singleStake, int totalStake, Dictionary<string, object> dic, DPR_CellManager cSF_CellManager)
	{
