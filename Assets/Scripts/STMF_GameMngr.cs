...
public class STMF_GameMngr : MonoBehaviour
{
	public static STMF_GameMngr G_GameMngr;
	...
	public int mPlayerSeatID
	{
		...
		{
			_playerSeatID = value;
			STMF_BulletPoolMngr.GetSingleton().SetPlayerIndex(_playerSeatID);
		}
	}

	public static STMF_GameMngr GetSingleton()
	{
		return G_GameMngr;
	}
	...
	private void Start()
	{
		STMF_NetMngr.GetSingleton().IsGameSceneLoadOk = true;
		mPlayerSeatID = STMF_GameInfo.getInstance().User.SeatIndex;
	}
	...
	private void OnApplicationPause(bool pauseStatus)
	{
		...
		STMF_NetMngr.GetSingleton().MyPostMessageThread.ClearAllState();
	}
	...
	{
		STMF_NetMngr.GetSingleton().IsGameSceneLoadOk = false;
		STMF_NetMngr.GetSingleton().mSceneBg = -1;
		Resources.UnloadUnusedAssets();
	}
}
