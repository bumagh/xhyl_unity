public class TF_TableInfo : TF_BaseItem
{
	...
	public TF_TableInfo(TF_FishDesk netDesk)
	{
		mId = netDesk.id;
		mName = netDesk.name;
	...
	public static int compareById(TF_TableInfo t1, TF_TableInfo t2)
	{
