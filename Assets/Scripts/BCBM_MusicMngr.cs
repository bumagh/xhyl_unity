...
public class BCBM_MusicMngr : MonoBehaviour
{
	...
	public static BCBM_MusicMngr G_MusicMngr;
	...
	public static BCBM_MusicMngr GetSingleton()
	{
		return G_MusicMngr;
	}
	...
	public void SetGameMusicVolume(float fVolume)
	{
		if (fVolume <= 1f && fVolume >= 0f)
		{
			...
			BCBM_Parameter.G_fGameMusicVolume = fVolume;
		}
	}

	public void SetMusicPlay(bool isTurnOn)
	{
		BCBM_Parameter.G_IsSoundOn = isTurnOn;
	}
