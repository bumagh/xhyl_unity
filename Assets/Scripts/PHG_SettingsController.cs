...
public class PHG_SettingsController : PHG_MB_Singleton<PHG_SettingsController>
{
	...
	private void Awake()
	{
		...
		if (PHG_MB_Singleton<PHG_SettingsController>._instance == null)
		{
			PHG_MB_Singleton<PHG_SettingsController>.SetInstance(this);
			PreInit();
		}
	}
	...
	public void InitBGMPlayerpef()
	{
		...
		if (_iBGM == 0)
		{
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_LobbyBGM, 0);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_DiceBGM, 0);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_MaryBGM, 0);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Dealer, 0);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Guys, 0);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Major, 0);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Mary, 0);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_NumberRoll, 0);
		}
		else if (_iBGM == 1)
		{
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_DiceBGM, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_MaryBGM, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Dealer, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Guys, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Major, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Mary, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_NumberRoll, 1);
		}
	}
	...
	public void InitClickPlayerpef()
	{
		...
		if (_iClickAudio == 0)
		{
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Click, 0);
		}
		else if (_iClickAudio == 1)
		{
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Click, 1);
		}
	}
	...
	public void OnBGMOpenBtnDown()
	{
		...
		{
			PHG_SoundManager.Instance.PlayClickAudio();
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_LobbyBGM, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_DiceBGM, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_MaryBGM, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Dealer, 1);
			PHG_SoundManager.Instance.SetAudioSourceVolum(PHG_SoundManager.Instance.ads_Guys, 1);
