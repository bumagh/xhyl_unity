public class DNTG_TableInfo : DNTG_BaseItem
{
	...
	public DNTG_TableInfo()
	{
	}

	public DNTG_TableInfo(DNTG_FishDesk netDesk)
	{
		mId = netDesk.id;
		mName = netDesk.name;
	...
	public static int compareById(DNTG_TableInfo t1, DNTG_TableInfo t2)
	{
