...
public class LRS_Rsymbol
{
	...
	public LRS_Rsymbol(Transform tran, int idx, LRS_RollSymbol RS, LRS_Symdata data, Action stopaction)
	{
		Rs = RS;
		Tran = tran;
		Data = data;
	...
	{
		frame = frameimg;
		seq_frame = frame.LRS_PlayAni("icon_guangxiao{0:0}", 1, 15f);
		seq_ani = img.LRS_PlayAni("spirit_big_{0:00}", 0, 15f);
		isbig = true;
	}
