...
public class DP_MusicMngr : MonoBehaviour
{
	...
	public static DP_MusicMngr G_MusicMngr;
	...
	public static DP_MusicMngr GetSingleton()
	{
		return G_MusicMngr;
	}
	...
	public void PlayGameMusic(MUSIC_GAME_MUSIC typ)
	{
		...
		case MUSIC_GAME_MUSIC.GAME_LUCKYPRIZE_BEGIN:
			...
			UnityEngine.Debug.LogError((int)(_nGameMusic_LuckyPrize_BgIndex + typ));
	...
	public void PlayLuckyPrizeSound(int nLuckyNum, int nLuckyTyp)
	{
		...
		{
			UnityEngine.Debug.Log("PlayLuckyPrizeSound _nLuckyNum error!");
			return;
		}
		...
		{
			UnityEngine.Debug.Log("PlayLuckyPrizeSound _nLuckyTyp error!");
		}
	}
	...
	private IEnumerator _playPrize()
	{
		...
		{
			UnityEngine.Debug.Log("Prize _nLuckyNum Error!" + _nLuckyNum);
		}
	}
	...
	public void SetGameMusicVolume(float fVolume)
	{
		if (fVolume <= 1f && fVolume >= 0f)
		{
			...
			LL_Parameter.G_fGameMusicVolume = fVolume;
		}
		else
		{
			UnityEngine.Debug.Log("SetGameMusicVolume params fVolume error: " + fVolume);
		}
	}

	public void SetMusicPlay(bool isTurnOn)
	{
		LL_Parameter.G_IsSoundOn = isTurnOn;
	}
	...
	private void _playSound(AudioSource audio, AudioClip clip, bool isLoop = false)
	{
		if (audio != null)
		{
			if (clip != null)
			{
				...
				audio.loop = isLoop;
				audio.clip = clip;
				audio.volume = LL_Parameter.G_fGameMusicVolume;
				audio.Play();
			}
			else
			{
