...
namespace FullInspector.Internal
{
	public class fiSerializedObjectSnapshot
	{
		...
		public bool IsEmpty => _keys.Count == 0 || _values.Count == 0;
		...
		public override bool Equals(object obj)
		{
			...
			if (object.ReferenceEquals(fiSerializedObjectSnapshot, null))
			{
				return false;
			}
			return AreEqual(_keys, fiSerializedObjectSnapshot._keys) && AreEqual(_values, fiSerializedObjectSnapshot._values) && AreEqual(_objectReferences, fiSerializedObjectSnapshot._objectReferences);
		}
