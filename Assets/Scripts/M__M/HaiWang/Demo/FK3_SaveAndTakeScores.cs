...
{
	public class FK3_SaveAndTakeScores : FK3_SimpleSingletonBehaviour<FK3_SaveAndTakeScores>
	{
		[SerializeField]
		...
		private void Awake()
		{
			FK3_SimpleSingletonBehaviour<FK3_SaveAndTakeScores>.s_instance = this;
		...
		public void HideInOutPanel()
		{
			...
			_imgYinDao.gameObject.SetActive(value: false);
		}
		...
		public void TakeScores()
		{
			...
			else if (_score + FK3_GVars.lobby.GetCurDesk().onceExchangeValue * FK3_GVars.lobby.GetCurDesk().exchange > 900000)
			{
				ShowScoreError(2);
			}
		...
		public IEnumerator GunMoveDelay()
		{
			...
			{
				_imgYinDao.gameObject.SetActive(value: true);
			}
		}
	}
}
