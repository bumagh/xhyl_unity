...
{
	public class FK3_HeadTitleController : FK3_SimpleSingletonBehaviour<FK3_HeadTitleController>
	{
		[SerializeField]
		...
		private void Awake()
		{
			FK3_SimpleSingletonBehaviour<FK3_HeadTitleController>.s_instance = this;
		}
		...
		public void Init()
		{
			_deskName.text = FK3_GVars.lobby.GetCurDesk().name;
		}
