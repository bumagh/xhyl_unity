...
{
	public class Fk3_FishEffect_CrabBoomEffect : MonoBehaviour
	{
		[SerializeField]
		...
		private FK3_FishBehaviour _crabBoom;
		...
		public void Init(FK3_FishBehaviour crabBoom)
		{
		...
		{
			UnityEngine.Debug.Log(FK3_LogHelper.Blue("爆炸效果"));
