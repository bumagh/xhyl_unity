...
{
	public class View_Test_Selector : ViewBase
	{
		...
		public View_Test_Selector()
		{
			...
			leftBtn.SetPosition(rectM.SetLayout(IMGUI_Layout_Type.BottomLeft).Clone());
			rightBtn.SetPosition(rectM.SetLayout(IMGUI_Layout_Type.BottomRight).Clone());
			analyzeBtn.SetPosition(rectM.SetLayout(IMGUI_Layout_Type.BottomLeft).Clone().SetMarginDown(30f));
		...
		public override void Display()
		{
			...
			rightBtn.Display();
			analyzeBtn.Display();
			Rect offsetRect = rectM.Clone().SetSize(200f, 25f).SetLayout(IMGUI_Layout_Type.BottomCenter)
