...
{
	[fiInspectorOnly]
	public class FK3_TestFishLogic : MonoBehaviour
	{
		[SerializeField]
		private FK3_FishBehaviour _targetFish;

		[SerializeField]
		private FK3_DragonBehaviour _dragon;
		...
		{
			_dragon.Event_FishDieFinish_Handler = delegate(FK3_FishBehaviour _)
			{
