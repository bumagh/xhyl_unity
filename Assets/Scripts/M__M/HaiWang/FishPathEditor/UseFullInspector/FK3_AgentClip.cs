...
{
	public class FK3_AgentClip : FK3_CurveClip
	{
		...
		public FK3_AgentClip()
		{
		}

		public FK3_AgentClip(BGCurve curve, BGCcMath math)
			: base(curve, math)
		{
		}
		...
		public override void MakePoints()
		{
			...
			Vector3 toDirection = FK3_MathUtils.V2Rotate(startTangent, angle).normalized;
		...
		{
			FK3_AgentClip fK3_AgentClip = new FK3_AgentClip(curve, math);
			fK3_AgentClip.angle = angle;
			fK3_AgentClip.agentCurve = agentCurve;
			return fK3_AgentClip;
		}
		...
		protected override Vector3 GetStartTangent()
		{
			...
			return (useTailAngle && base.usePrevTail && prevTailInfo != null) ? prevTailInfo.tangent : FK3_TailInfo.Default.tangent;
		}
	}
}
