...
{
	public class SineWaveClip : CurveClip
	{
		...
		public override void MakePoints()
		{
			...
			Vector3 toDirection = MathUtils.V2Rotate(startTangent, startAngle).normalized;
		...
		{
			SineWaveClip sineWaveClip = new SineWaveClip();
			sineWaveClip.startPhaseDegree = startPhaseDegree;
			sineWaveClip.phaseNumber = phaseNumber;
			sineWaveClip.quarter = quarter;
			sineWaveClip.amplitude = amplitude;
			sineWaveClip.startAngle = startAngle;
			return sineWaveClip;
		}
	}
}
