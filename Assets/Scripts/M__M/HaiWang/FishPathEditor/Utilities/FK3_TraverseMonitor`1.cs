...
{
	public class FK3_TraverseMonitor<T>
	{
		...
		public FK3_TraverseMonitor(int depthLimit = int.MaxValue, NodeCallback onReachDepthLimit = null, int countLimit = int.MaxValue, NodeCallback onReachCountLimit = null, NodeCallback onReachNode = null)
		{
