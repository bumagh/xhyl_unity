...
{
	public class FK3_Effect_LogoMgr : MonoBehaviour
	{
		...
		private static FK3_Effect_LogoMgr s_instance;

		private FK3_SpawnPool m_logoPool;

		private List<FK3_Effect_Logo> m_logoList = new List<FK3_Effect_Logo>();
		...
		public static FK3_Effect_LogoMgr Get()
		{
			return s_instance;
		}
		...
		private void Init()
		{
			m_logoPool = FK3_PoolManager.Pools["Logo"];
		}

		public FK3_Effect_Logo SpawnGoldSharkLogo(Vector3 pos, int seatId)
		{
			...
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_GoldShark>();
			component.SetLayerOrder(m_logoOrderMap[LogoType.Normal].GetOrder());
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_GoldShark)
			{
		...
		public FK3_Effect_Logo SpawnLightingLogo(Vector3 pos, int seatId, int bulletPower)
		{
			Transform prefab = m_logoPool.prefabs["LogoLighting"];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_Lighting>();
			component.SetLayerOrder(m_logoOrderMap[LogoType.Normal].GetOrder());
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_Lighting)
			{
		...
		public FK3_Effect_Logo SpawnLogoScore(Vector3 pos, int seatId, int totalScore, LogoScoreTypes logoScoreType)
		{
			Transform prefab = m_logoPool.prefabs[GetScorePrebName(logoScoreType)];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_Score>();
			component.SetLayerOrder(m_logoOrderMap[LogoType.Score].GetOrder());
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_LightingScore)
			{
		...
		public FK3_Effect_Logo SpawnLaserGunLogo(Vector3 pos, int seatId, int bulletPower)
		{
			Transform prefab = m_logoPool.prefabs["LogoLaserGun"];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_LaserGun>();
			component.SetLayerOrder(m_logoOrderMap[LogoType.Normal].GetOrder());
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_LaserGun)
			{
		...
		public FK3_Effect_Logo SpawnDrillGunLogo(Vector3 pos, int seatId, int bulletPower)
		{
			Transform prefab = m_logoPool.prefabs["LogoDrillGun"];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_LaserGun>();
			component.SetLayerOrder(m_logoOrderMap[LogoType.Normal].GetOrder());
		...
		public FK3_Effect_Logo SpawnBombCrabLogo(Vector3 pos, int seatId, int bulletPower)
		{
			Transform prefab = m_logoPool.prefabs["LogoBombCrab"];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_BombCrab>();
			component.SetLayerOrder(m_logoOrderMap[LogoType.Normal].GetOrder());
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_BombCrab)
			{
		...
		public FK3_Effect_Logo SpawnCaymanLogo(Vector3 pos, int seatId, int bulletPower)
		{
			Transform prefab = m_logoPool.prefabs["Logo_BossCayman"];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_BombCrab>();
			component.SetLayerOrder(m_logoOrderMap[LogoType.Normal].GetOrder());
		...
		public Transform SpawnBossCrabLogo(string name)
		{
			return m_logoPool.Spawn(m_logoPool.prefabs[name], m_logoPool.transform);
		}

		public FK3_Effect_Logo SpawnBossCrabShadow(Vector3 pos)
		{
			Transform prefab = m_logoPool.prefabs["BossCrabShadow"];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_BossCrabShadow>();
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_BossCrabShadow)
			{
		...
		public FK3_Effect_Logo SpawnBossKrakenShadow(Vector3 pos)
		{
			UnityEngine.Debug.LogError("生成池: " + m_logoPool.name);
			Transform prefab = m_logoPool.prefabs["BossKrakenShadow"];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_BossKrankenShadow>();
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_BossKrakenShadow)
			{
		...
		public FK3_Effect_Logo SpawnBossCrystalFire(Vector3 pos)
		{
			...
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_CrystalFire>();
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_BossCrystalFire)
			{
		...
		private string[] GetBossPrefabCrastalAndLogoName(FK3_FishType fishType)
		{
		...
		public FK3_Effect_Logo SpawnBossCrystal(FK3_FishType fishType)
		{
			Transform prefab = m_logoPool.prefabs[GetBossPrefabCrastalAndLogoName(fishType)[0]];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_Crystal>();
			component.SetLayerOrder(logo_BossOrder + 1);
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_BossCrystalDragon)
			{
		...
		public FK3_Effect_Logo SpawnBossLogo(FK3_FishType fishType)
		{
			Transform prefab = m_logoPool.prefabs[GetBossPrefabCrastalAndLogoName(fishType)[1]];
			Transform transform = m_logoPool.transform;
			Transform transform2 = m_logoPool.Spawn(prefab, transform);
			FK3_Effect_Logo component = transform2.GetComponent<FK3_Effect_Logo_Boss>();
			logo_BossOrder = m_logoOrderMap[LogoType.Boss].GetOrder();
			component.SetLayerOrder(logo_BossOrder);
			m_logoList.Add(component);
			component.Reset_EventHandler();
			component.Event_Over_Handler += delegate(FK3_Effect_Logo _logo_Boss)
			{
		...
		{
			foreach (FK3_Effect_Logo logo in m_logoList)
			{
