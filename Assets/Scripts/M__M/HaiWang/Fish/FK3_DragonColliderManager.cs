...
{
	public class FK3_DragonColliderManager : MonoBehaviour
	{
		[SerializeField]
		...
		[SerializeField]
		private FK3_FishBehaviour fishBehaviour;
		...
		{
			FK3_DragonColliderControl fK3_DragonColliderControl = col.gameObject.AddComponent<FK3_DragonColliderControl>();
			fK3_DragonColliderControl.Event_DragonOnHit_Handler += Test;
		}
