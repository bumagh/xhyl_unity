...
{
	[Serializable]
	public class FK3_CrabScenario : FK3_ScenarioBase
	{
		public Image bg_green;

		public Image floating_island;

		private FK3_CrabScenario()
			: base(FK3_ScenarioType.Boss_Crab_霸王蟹)
		{
		}
		...
		public override void Enter()
		{
			Stop_Crab();
			Reset_Crab();
			UnityEngine.Debug.Log(FK3_LogHelper.Brown("FK3_CrabScenario Enter"));
			FK3_Singleton<FK3_SoundMgr>.Get().PlayClip("霸王蟹剧情背景音乐", loop: true);
			FK3_Singleton<FK3_SoundMgr>.Get().SetVolume("霸王蟹剧情背景音乐", 0.7f);
		...
		{
			UnityEngine.Debug.Log(FK3_LogHelper.Magenta("FK3_CrabScenario BossEnter"));
