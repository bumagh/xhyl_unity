...
{
	public class FK3_MessageCenter : MonoBehaviour
	{
		public delegate void HandleMessage(FK3_KeyValueInfo keyValueInfo);
		...
		public static void SendMessage(string key, FK3_KeyValueInfo keyValueInfo)
		{
