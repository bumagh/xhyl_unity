...
public class CRL_SoundManager : MonoBehaviour
{
	public static CRL_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(CRL_CellType celltype, int ImgNum = 0)
	{
		if (typeOfPlayEffect.Length > 0)
		{
