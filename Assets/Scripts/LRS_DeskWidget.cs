...
public class LRS_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(LRS_Desk desk)
	{
		...
		_textMinCoin.text = ((!(LRS_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(LRS_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
