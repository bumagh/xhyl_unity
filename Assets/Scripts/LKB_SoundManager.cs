...
public class LKB_SoundManager : MonoBehaviour
{
	public static LKB_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(LKB_CellType celltype, int ImgNum = 0)
	{
		if (typeOfPlayEffect.Length > 0)
		{
