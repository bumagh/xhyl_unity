...
public class LL_LuckyPrizeCtrl : MonoBehaviour
{
	private LL_LuckySpin _luckySpin;
	...
	private void Start()
	{
		_luckySpin = GetComponent<LL_LuckySpin>();
	...
	public void SpinLuckyPrize(int nTaihao, LL_LuckySpin.LuckyType luckyTyp, float fTaiHao_Time, float fLuckyTyp_Time)
	{
		Reset();
	...
	public void FlipClosePlatform(float fDelay, float time)
	{
		...
		LL_MusicMngr.GetSingleton().PlaySceneSound(LL_MusicMngr.MUSIC_SCENE_MUSIC.SCENE_FLIP_PLATE);
	}
