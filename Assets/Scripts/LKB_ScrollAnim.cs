...
public class LKB_ScrollAnim : MonoBehaviour
{
	...
	private float[] posScroll = new float[14]
	{
		15f,
		805f,
		565f,
	...
	public IEnumerator AniStart(LKB_CellType startType)
	{
		yield return null;
		bRoll = true;
		float acc = 25f;
	...
	public IEnumerator AniStop(LKB_CellType endType)
	{
		yield return null;
		float acc = 10f;
		float accTime = 0.3f;
