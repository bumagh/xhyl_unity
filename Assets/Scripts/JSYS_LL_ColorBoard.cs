...
public class JSYS_LL_ColorBoard : MonoBehaviour
{
	...
	public JSYS_LL_SpinScript m_LightPoiter;
	...
	private void Start()
	{
		...
		m_LightPoiter = GameObject.Find("BallPointer").GetComponent<JSYS_LL_SpinScript>();
		Reset();
	}
	...
	{
		JSYS_LL_MusicMngr.GetSingleton().PlayGameMusic(JSYS_LL_MusicMngr.MUSIC_GAME_MUSIC.GAME_BG);
		JSYS_LL_MusicMngr.GetSingleton().PlaySceneSound(JSYS_LL_MusicMngr.MUSIC_SCENE_MUSIC.SCENE_RESET_COLOR);
