...
public class STQM_DataEncrypt : MonoBehaviour
{
	private string key = "none";

	private string IVKey = "Qzh0Qxebwie8Kvse";

	private static STQM_DataEncrypt _MyDataEncrypt;
	...
	public static STQM_DataEncrypt GetSingleton()
	{
	...
	public string[] NetConnectGetRsaKey()
	{
		...
		return new string[2]
		{
			STQM_SafeTools.Adjust_String_1(innerText),
			innerText2
		};
	}
