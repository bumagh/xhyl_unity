...
public class JSYS_LL_DataIOWin
{
	private string mRsgName;

	private static JSYS_LL_DataIOWin g_Singleton;
	...
	public static JSYS_LL_DataIOWin GetSingleton()
	{
		if (g_Singleton == null)
		{
			g_Singleton = new JSYS_LL_DataIOWin();
		}
		return g_Singleton;
	}
