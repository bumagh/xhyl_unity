...
public class SHT_DeskWidget : MonoBehaviour
{
	...
	public void InitDesk(SHT_Desk desk)
	{
		...
		_textMinCoin.text = ((!(SHT_GVars.language == "zh")) ? "Min Coin :" : "最小携带：") + desk.minGold.ToString();
		_textCoinRate.text = ((!(SHT_GVars.language == "zh")) ? "Min Coin :" : "一币分值：") + desk.exchange.ToString();
	}
