...
public class LLD_SoundManager : MonoBehaviour
{
	public static LLD_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(LLD_CellType celltype, int ImgNum = 0)
	{
		if (typeOfPlayEffect.Length > 0)
		{
