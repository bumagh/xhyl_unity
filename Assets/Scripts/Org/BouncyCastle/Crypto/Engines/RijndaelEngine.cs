...
namespace Org.BouncyCastle.Crypto.Engines
{
	public class RijndaelEngine : IBlockCipher
	{
		...
		private long[][] GenerateWorkingKey(byte[] key)
		{
			...
			int num6 = 0;
			int num7 = 0;
			while (num7 < num3 && num6 < (ROUNDS + 1) * (BC / 8))
			{
				for (int k = 0; k < 4; k++)
				{
					array2[num6 / (BC / 8)][k] |= (long)(array[k, num7] & 0xFF) << num6 * 8 % BC;
				}
				num7++;
				num6++;
			}
			while (num6 < (ROUNDS + 1) * (BC / 8))
			{
				for (int l = 0; l < 4; l++)
				{
				...
				{
					for (int num9 = 1; num9 < 4; num9++)
					{
						for (int num10 = 0; num10 < 4; num10++)
						{
							array[num10, num9] ^= array[num10, num9 - 1];
						}
					}
					for (int num11 = 0; num11 < 4; num11++)
					{
						array[num11, 4] ^= S[array[num11, 3] & 0xFF];
					}
					for (int num12 = 5; num12 < num3; num12++)
					{
				...
				int num14 = 0;
				while (num14 < num3 && num6 < (ROUNDS + 1) * (BC / 8))
				{
					for (int num15 = 0; num15 < 4; num15++)
					{
						array2[num6 / (BC / 8)][num15] |= (long)(array[num15, num14] & 0xFF) << num6 * 8 % BC;
					}
					num14++;
					num6++;
				}
