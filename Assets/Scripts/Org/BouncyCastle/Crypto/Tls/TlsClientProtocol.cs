...
namespace Org.BouncyCastle.Crypto.Tls
{
	public class TlsClientProtocol : TlsProtocol
	{
		...
		protected override void HandleHandshakeMessage(byte type, byte[] data)
		{
			...
			case 11:
			{
				short mConnectionState3 = base.mConnectionState;
				if (mConnectionState3 == 2 || mConnectionState3 == 3)
				{
			...
			case 22:
			{
				short mConnectionState6 = base.mConnectionState;
				if (mConnectionState6 == 4)
				{
			...
			case 20:
			{
				short mConnectionState4 = base.mConnectionState;
				if (mConnectionState4 == 13 || mConnectionState4 == 14)
				{
			...
			case 2:
			{
				short mConnectionState5 = base.mConnectionState;
				if (mConnectionState5 == 1)
				{
			...
			case 4:
			{
				short mConnectionState2 = base.mConnectionState;
