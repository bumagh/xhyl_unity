...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecT193R1Point : AbstractF2mPoint
	{
		...
		public override ECPoint Add(ECPoint b)
		{
			...
			return new SecT193R1Point(curve, eCFieldElement10, y, new ECFieldElement[1]
			{
				eCFieldElement12
			}, base.IsCompressed);
		}
		...
		public override ECPoint TwicePlus(ECPoint b)
		{
			...
			return new SecT193R1Point(curve, x2, y, new ECFieldElement[1]
			{
				eCFieldElement8
			}, base.IsCompressed);
		}
		...
		public override ECPoint Negate()
		{
			...
			ECFieldElement rawYCoord = base.RawYCoord;
			ECFieldElement eCFieldElement = base.RawZCoords[0];
			return new SecT193R1Point(Curve, rawXCoord, rawYCoord.Add(eCFieldElement), new ECFieldElement[1]
			{
				eCFieldElement
			}, base.IsCompressed);
		}
