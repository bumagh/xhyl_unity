	...
	internal class SecT571Field
	{
		...
		public static void Sqrt(ulong[] x, ulong[] z)
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				ulong num5 = Interleave.Unshuffle(x[num++]);
				array[i] = ((num3 & uint.MaxValue) | (num5 << 32));
				array2[i] = (ulong)((long)(num3 >> 32) | ((long)num5 & -4294967296L));
			}
			ulong num6 = Interleave.Unshuffle(x[num]);
			array[4] = (num6 & uint.MaxValue);
			array2[4] = num6 >> 32;
