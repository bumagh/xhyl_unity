...
namespace Org.BouncyCastle.Math.EC.Custom.Sec
{
	internal class SecT283Field
	{
		...
		public static void Sqrt(ulong[] x, ulong[] z)
		{
			...
			array[0] = (ulong)((long)(num >> 32) | ((long)num2 & -4294967296L));
			num = Interleave.Unshuffle(x[2]);
			num2 = Interleave.Unshuffle(x[3]);
			ulong num4 = (num & uint.MaxValue) | (num2 << 32);
			array[1] = (ulong)((long)(num >> 32) | ((long)num2 & -4294967296L));
			num = Interleave.Unshuffle(x[4]);
			ulong num5 = num & uint.MaxValue;
			array[2] = num >> 32;
