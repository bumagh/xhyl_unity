...
public class LRS_SoundManager : MonoBehaviour
{
	public static LRS_SoundManager Instance;
	...
	public void PlayMajorGameAwardAudio(LRS_CellType celltype, int ImgNum = 0)
	{
