...
public class BCBM_LuckyLion_SoundManager : MonoBehaviour
{
	...
	protected static BCBM_LuckyLion_SoundManager gSingleton;
	...
	public static BCBM_LuckyLion_SoundManager GetSingleton()
	{
		return gSingleton;
	}
	...
	public void PlayGameHallMusic()
	{
		...
		{
			BCBM_ErrorManager.GetSingleton().AddError("game hall background source null");
		}
		else
		{
			BCBM_ErrorManager.GetSingleton().AddError("game hall background clip null");
		}
	}
	...
	public void playButtonSound(EUIBtnSoundType soundType = EUIBtnSoundType.BtnSound)
	{
		...
		{
			BCBM_ErrorManager.GetSingleton().AddError("button source null");
		}
		else
		{
			BCBM_ErrorManager.GetSingleton().AddError("button clip null");
		}
	}
	...
	public void SetMusicVolume(float fVolume)
	{
		...
		{
			BCBM_ErrorManager.GetSingleton().AddError("Error:音量设置错误" + fVolume);
			fVolume = 0.5f;
		}
